...
<!-- <h3>메뉴</h3> -->
  ...
  <div class= "menubut">
   ...
   <button type="button" class="but1" onclick="selectkind('디저트')" value ="디저트">디저트/원두</button>
   <button type="button" class="but1" onclick="okList('판매가능')" value ="판매가능">품절제외</button>
   </div>

  <div class="dropdown" id="mdMenu">
    <button type="button" class="btn-primary dropdown-toggle mddrop" data-toggle="dropdown">
      MENU
    </button>
   ...
   <button type="button" class="dropdown-item" onclick="selectkind('디저트')" value ="디저트">디저트/원두</button>
    </div>
  </div>
...
<div class="col-lg-3 col-md-6 col-sm-10 mdcard">
  <div class="card">
    <img class="mdimg" id="mdimg" src="resources/img/${md.m_img}" alt="${md.m_name}" title="${md.m_name}">
    <div class="card-body">
 ...
 <button id="scrollBtn"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"  class="bi bi-arrow-up-circle-fill" viewBox="0 0 16 16">
